...
namespace Repository.Pattern.InMemory.IntegrationTests.DomainModel
{
    public class DomainModelClass: IDomainModel
    {
        ...
        public string PartitionKey => AString;
        public string RowKey => $"{AnotherString}_{AGuid}";
